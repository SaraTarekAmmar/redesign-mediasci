        ...
        {!loading && !planId && projectId && (
          <div className="rounded-xl border border-dashed border-border bg-card p-6 md:p-10">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">Create the schedule container, then add work and connect dependencies from the planning workspace.</p>
              <div className="mt-5 flex justify-center"><Button size="sm" onClick={createDefaultPlan}>{t("enterpriseGantt.createPlan")}</Button></div>
            </div>
          </div>
        )}
